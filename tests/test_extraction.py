...
def test_service_date_parser_supports_numeric_and_alphabetic_indian_dates() -> None:
    ...
    assert parse_service_date("2026-02-12") == "2026-02-12"
    assert parse_service_date("2026-02-12 10:24:02") == "2026-02-12"
    assert parse_service_date("2026/02/12, 10:24 pm") == "2026-02-12"
