...
from gmoney.profiles.aliases import AliasRegistryUnavailable, JsonAliasRepository
...
def test_registry_validation_failure_is_reported_as_unavailable(tmp_path: Path) -> None:
